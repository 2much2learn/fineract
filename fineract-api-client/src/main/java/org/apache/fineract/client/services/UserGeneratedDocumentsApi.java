...
public interface UserGeneratedDocumentsApi {
   ...
   */
  @GET("templates")
  Call<GetTemplatesResponse> retrieveAll39(
  ...
  Call<GetTemplatesTemplateIdResponse> retrieveOne27(
            @retrofit2.http.Path("templateId") Long templateId            
  );
  ...
  Call<PutTemplatesTemplateIdResponse> saveTemplate(
                    @retrofit2.http.Body PutTemplatesTemplateIdRequest body    ,         @retrofit2.http.Path("templateId") Long templateId            
  );
