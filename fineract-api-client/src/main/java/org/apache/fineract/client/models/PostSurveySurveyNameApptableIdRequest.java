...
public class PostSurveySurveyNameApptableIdRequest {
  ...
  **/
  @Schema(example = "167", description = "")
  ...
  **/
  @Schema(example = "174", description = "")
  ...
  **/
  @Schema(example = "184", description = "")
  ...
  **/
  @Schema(example = "188", description = "")
  ...
  **/
  @Schema(example = "190", description = "")
  ...
  **/
  @Schema(example = "193", description = "")
  ...
  **/
  @Schema(example = "195", description = "")
