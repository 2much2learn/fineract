...
public interface ClientApi {
  ...
  Call<PostClientsClientIdResponse> activate1(
                    @retrofit2.http.Body PostClientsClientIdRequest body    ,         @retrofit2.http.Path("clientId") Long clientId            ,     @retrofit2.http.Query("command") String command                
  );
  ...
  @POST("clients")
  Call<PostClientsResponse> create5(
  ...
  Call<DeleteClientsClientIdResponse> delete9(
                    @retrofit2.http.Body DeleteClientsClientIdRequest body    ,         @retrofit2.http.Path("clientId") Long clientId            
  );
  ...
  Call<String> postClientTemplate(
                        @retrofit2.http.Part("file") FormDataContentDisposition file,                     @retrofit2.http.Part("locale") String locale,                     @retrofit2.http.Part("dateFormat") String dateFormat,     @retrofit2.http.Query("legalFormType") String legalFormType                
  );
   ...
   */
  @GET("clients")
  Call<GetClientsResponse> retrieveAll20(
  ...
  Call<GetClientsClientIdResponse> retrieveOne10(
  ...
  Call<PutClientsClientIdResponse> update9(
                    @retrofit2.http.Body PutClientsClientIdRequest body    ,         @retrofit2.http.Path("clientId") Long clientId            
  );
