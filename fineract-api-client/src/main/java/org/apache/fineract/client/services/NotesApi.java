...
public interface NotesApi {
  ...
  Call<PostResourceTypeResourceIdNotesResponse> addNewNote(
                    @retrofit2.http.Body PostResourceTypeResourceIdNotesRequest body    ,         @retrofit2.http.Path("resourceType") String resourceType            ,         @retrofit2.http.Path("resourceId") Long resourceId            
  );
  ...
  Call<PutResourceTypeResourceIdNotesNoteIdResponse> updateNote(
                    @retrofit2.http.Body PutResourceTypeResourceIdNotesNoteIdRequest body    ,         @retrofit2.http.Path("resourceType") String resourceType            ,         @retrofit2.http.Path("resourceId") Long resourceId            ,         @retrofit2.http.Path("noteId") Long noteId            
  );
