...
public class GetLoansLoanIdResponse {
  ...
  **/
  @Schema(example = "Kampala Product (with cash accounting)", description = "")
  ...
  **/
  @Schema(example = "Typical Kampala loan product with cash accounting enabled for testing.", description = "")
  ...
  **/
  @Schema(example = "option.HousingImprovement", description = "")
  ...
  **/
  @Schema(example = "LoanOfficer, Kampala", description = "")
