...
public interface LoansApi {
  ...
  Call<PostLoansLoanIdResponse> glimStateTransitions(
                    @retrofit2.http.Body PostLoansLoanIdRequest body    ,         @retrofit2.http.Path("glimId") Long glimId            ,     @retrofit2.http.Query("command") String command                
  );
  ...
  Call<PutLoansLoanIdResponse> modifyLoanApplication(
                    @retrofit2.http.Body PutLoansLoanIdRequest body    ,         @retrofit2.http.Path("loanId") Long loanId            
  );
   ...
   */
  @GET("loans")
  Call<GetLoansResponse> retrieveAll26(
  ...
  Call<PostLoansLoanIdResponse> stateTransitions(
                    @retrofit2.http.Body PostLoansLoanIdRequest body    ,         @retrofit2.http.Path("loanId") Long loanId            ,     @retrofit2.http.Query("command") String command                
  );
