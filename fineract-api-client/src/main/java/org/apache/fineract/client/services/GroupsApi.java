...
public interface GroupsApi {
  ...
  Call<PostGroupsGroupIdResponse> activateOrGenerateCollectionSheet(
                    @retrofit2.http.Body PostGroupsGroupIdRequest body    ,         @retrofit2.http.Path("groupId") Long groupId            ,     @retrofit2.http.Query("command") String command                ,     @retrofit2.http.Query("roleId") Long roleId                
  );
  ...
  @POST("groups")
  Call<PostGroupsResponse> create7(
   ...
   */
  @GET("groups")
  Call<GetGroupsResponse> retrieveAll23(
   ...
   */
  @GET("groups/{groupId}")
  Call<GetGroupsGroupIdResponse> retrieveOne13(
  ...
  Call<PostGroupsGroupIdCommandUnassignStaffResponse> unassignLoanOfficer(
                    @retrofit2.http.Body PostGroupsGroupIdCommandUnassignStaffRequest body    ,         @retrofit2.http.Path("groupId") Long groupId            
  );
  ...
  @PUT("groups/{groupId}")
  Call<PutGroupsGroupIdResponse> update11(
                    @retrofit2.http.Body PutGroupsGroupIdRequest body    ,         @retrofit2.http.Path("groupId") Long groupId            
  );
