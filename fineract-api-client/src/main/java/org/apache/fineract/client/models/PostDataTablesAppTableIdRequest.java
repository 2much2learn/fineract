...
public class PostDataTablesAppTableIdRequest {
  ...
  **/
  @Schema(example = "Livestock sales", description = "")
   ...
   * @return comment
  **/
  @Schema(example = "First comment made", description = "")
  ...
  **/
  @Schema(example = "8.5", description = "")
   ...
   * @return nextVisit
  **/
  @Schema(example = "01 October 2012", description = "")
