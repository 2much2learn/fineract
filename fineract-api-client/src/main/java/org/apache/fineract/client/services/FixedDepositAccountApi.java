...
public interface FixedDepositAccountApi {
  ...
  Call<PostFixedDepositAccountsAccountIdResponse> handleCommands4(
                    @retrofit2.http.Body PostFixedDepositAccountsAccountIdRequest body    ,         @retrofit2.http.Path("accountId") Long accountId            ,     @retrofit2.http.Query("command") String command                
  );
  ...
  Call<List<GetFixedDepositAccountsResponse>> retrieveAll28(
  ...
  Call<GetFixedDepositAccountsAccountIdResponse> retrieveOne17(
  ...
  Call<PutFixedDepositAccountsAccountIdResponse> update14(
                    @retrofit2.http.Body PutFixedDepositAccountsAccountIdRequest body    ,         @retrofit2.http.Path("accountId") Long accountId            
  );
