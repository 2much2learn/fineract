...
public interface ClientIdentifierApi {
  ...
  Call<PostClientsClientIdIdentifiersResponse> createClientIdentifier(
                    @retrofit2.http.Body PostClientsClientIdIdentifiersRequest body    ,         @retrofit2.http.Path("clientId") Long clientId            
  );
  ...
  Call<PutClientsClientIdIdentifiersIdentifierIdResponse> updateClientIdentifer(
                    @retrofit2.http.Body PutClientsClientIdIdentifiersIdentifierIdRequest body    ,         @retrofit2.http.Path("clientId") Long clientId            ,         @retrofit2.http.Path("identifierId") Long identifierId            
  );
