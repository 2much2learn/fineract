...
public class GetLoansTotal {
   ...
   * @return currencyCode
  **/
  @Schema(example = "XOF", description = "")
  ...
  **/
   ...
   * @return amount
  **/
  @Schema(example = "471", description = "")
   ...
   * @return defaultName
  **/
  @Schema(example = "CFA Franc BCEAO", description = "")
   ...
   * @return nameCode
  **/
  @Schema(example = "currency.XOF", description = "")
  ...
  **/
  @Schema(example = "CFA", description = "")
  ...
  **/
  @Schema(example = "471 CFA", description = "")
