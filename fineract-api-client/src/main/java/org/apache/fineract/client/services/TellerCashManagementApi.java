...
public interface TellerCashManagementApi {
  ...
  Call<PostTellersTellerIdCashiersCashierIdAllocateResponse> allocateCashToCashier(
                    @retrofit2.http.Body PostTellersTellerIdCashiersCashierIdAllocateRequest body    ,         @retrofit2.http.Path("tellerId") Long tellerId            ,         @retrofit2.http.Path("cashierId") Long cashierId            
  );
  ...
  Call<PostTellersTellerIdCashiersResponse> createCashier(
                    @retrofit2.http.Body PostTellersTellerIdCashiersRequest body    ,         @retrofit2.http.Path("tellerId") Long tellerId            
  );
  ...
  Call<PostTellersTellerIdCashiersCashierIdSettleResponse> settleCashFromCashier(
                    @retrofit2.http.Body PostTellersTellerIdCashiersCashierIdSettleRequest body    ,         @retrofit2.http.Path("tellerId") Long tellerId            ,         @retrofit2.http.Path("cashierId") Long cashierId            
  );
  ...
  Call<PutTellersTellerIdCashiersCashierIdResponse> updateCashier(
                    @retrofit2.http.Body PutTellersTellerIdCashiersCashierIdRequest body    ,         @retrofit2.http.Path("tellerId") Long tellerId            ,         @retrofit2.http.Path("cashierId") Long cashierId            
  );
  ...
  Call<PutTellersResponse> updateTeller(
                    @retrofit2.http.Body PutTellersRequest body    ,         @retrofit2.http.Path("tellerId") Long tellerId            
  );
