...
public interface ClientsAddressApi {
  ...
  Call<PostClientClientIdAddressesResponse> addClientAddress(
                    @retrofit2.http.Body PostClientClientIdAddressesRequest body    ,         @retrofit2.http.Path("clientid") Long clientid            ,     @retrofit2.http.Query("type") Long type                
  );
  ...
  Call<PutClientClientIdAddressesResponse> updateClientAddress(
                    @retrofit2.http.Body PutClientClientIdAddressesRequest body    ,         @retrofit2.http.Path("clientid") Long clientid            
  );
