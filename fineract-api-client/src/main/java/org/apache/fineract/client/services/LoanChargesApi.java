...
public interface LoanChargesApi {
  ...
  Call<PostLoansLoanIdChargesChargeIdResponse> executeLoanCharge(
                    @retrofit2.http.Body PostLoansLoanIdChargesChargeIdRequest body    ,         @retrofit2.http.Path("loanId") Long loanId            ,         @retrofit2.http.Path("chargeId") Long chargeId            ,     @retrofit2.http.Query("command") String command                
  );
  ...
  Call<PostLoansLoanIdChargesResponse> executeLoanCharge1(
                    @retrofit2.http.Body PostLoansLoanIdChargesRequest body    ,         @retrofit2.http.Path("loanId") Long loanId            ,     @retrofit2.http.Query("command") String command                
  );
  ...
  Call<PutLoansLoanIdChargesChargeIdResponse> updateLoanCharge(
                    @retrofit2.http.Body PutLoansLoanIdChargesChargeIdRequest body    ,         @retrofit2.http.Path("loanId") Long loanId            ,         @retrofit2.http.Path("chargeId") Long chargeId            
  );
