...
public interface StandingInstructionsApi {
  ...
  Call<PostStandingInstructionsResponse> create4(
  ...
  Call<GetStandingInstructionsResponse> retrieveAll18(
  ...
  Call<GetStandingInstructionsStandingInstructionIdResponse> retrieveOne9(
  ...
  Call<PutStandingInstructionsStandingInstructionIdResponse> update8(
            @retrofit2.http.Path("standingInstructionId") Long standingInstructionId            ,                 @retrofit2.http.Body PutStandingInstructionsStandingInstructionIdRequest body    ,     @retrofit2.http.Query("command") String command                
  );
