...
public interface SelfLoansApi {
  ...
  Call<PutSelfLoansLoanIdResponse> modifyLoanApplication1(
                    @retrofit2.http.Body PutSelfLoansLoanIdRequest body    ,         @retrofit2.http.Path("loanId") Long loanId            
  );
  ...
  Call<PostSelfLoansLoanIdResponse> stateTransitions1(
                    @retrofit2.http.Body PostSelfLoansLoanIdRequest body    ,         @retrofit2.http.Path("loanId") Long loanId            ,     @retrofit2.http.Query("command") String command                
  );
