...
public interface FloatingRatesApi {
   ...
   */
  @GET("floatingrates")
  Call<List<GetFloatingRatesResponse>> retrieveAll21();
  ...
  Call<GetFloatingRatesFloatingRateIdResponse> retrieveOne11(
  ...
  Call<PutFloatingRatesFloatingRateIdResponse> updateFloatingRate(
                    @retrofit2.http.Body PutFloatingRatesFloatingRateIdRequest body    ,         @retrofit2.http.Path("floatingRateId") Long floatingRateId            
  );
