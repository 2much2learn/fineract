...
public interface SelfDividendApi {
  ...
  Call<String> updateDividendDetail(
            @retrofit2.http.Path("productId") Long productId            ,         @retrofit2.http.Path("dividendId") Long dividendId            ,                 @retrofit2.http.Body String body    ,     @retrofit2.http.Query("command") String command                
  );
