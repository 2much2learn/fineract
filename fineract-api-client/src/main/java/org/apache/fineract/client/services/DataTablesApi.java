...
public interface DataTablesApi {
  ...
  Call<PostDataTablesAppTableIdResponse> createDatatableEntry(
                    @retrofit2.http.Body PostDataTablesAppTableIdRequest body    ,         @retrofit2.http.Path("datatable") String datatable            ,         @retrofit2.http.Path("apptableId") Long apptableId            
  );
  ...
  Call<GetDataTablesResponse> getDatatable1(
            @retrofit2.http.Path("datatable") String datatable            
  );
  ...
  Call<PutDataTablesResponse> updateDatatable(
                    @retrofit2.http.Body PutDataTablesRequest body    ,         @retrofit2.http.Path("datatableName") String datatableName            
  );
  ...
  Call<PutDataTablesAppTableIdDatatableIdResponse> updateDatatableEntryOneToMany(
                    @retrofit2.http.Body PutDataTablesAppTableIdDatatableIdRequest body    ,         @retrofit2.http.Path("datatable") String datatable            ,         @retrofit2.http.Path("apptableId") Long apptableId            ,         @retrofit2.http.Path("datatableId") Long datatableId            
  );
  ...
  Call<PutDataTablesAppTableIdResponse> updateDatatableEntryOnetoOne(
                    @retrofit2.http.Body PutDataTablesAppTableIdRequest body    ,         @retrofit2.http.Path("datatable") String datatable            ,         @retrofit2.http.Path("apptableId") Long apptableId            
  );
