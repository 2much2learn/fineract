...
public interface SavingsChargesApi {
  ...
  Call<PostSavingsAccountsSavingsAccountIdChargesResponse> addSavingsAccountCharge(
                    @retrofit2.http.Body PostSavingsAccountsSavingsAccountIdChargesRequest body    ,         @retrofit2.http.Path("savingsAccountId") Long savingsAccountId            
  );
  ...
  Call<PostSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdResponse> payOrWaiveSavingsAccountCharge(
                    @retrofit2.http.Body PostSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdRequest body    ,         @retrofit2.http.Path("savingsAccountId") Long savingsAccountId            ,         @retrofit2.http.Path("savingsAccountChargeId") Long savingsAccountChargeId            ,     @retrofit2.http.Query("command") String command                
  );
  ...
  Call<PutSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdResponse> updateSavingsAccountCharge(
                    @retrofit2.http.Body PutSavingsAccountsSavingsAccountIdChargesSavingsAccountChargeIdRequest body    ,         @retrofit2.http.Path("savingsAccountId") Long savingsAccountId            ,         @retrofit2.http.Path("savingsAccountChargeId") Long savingsAccountChargeId            
  );
