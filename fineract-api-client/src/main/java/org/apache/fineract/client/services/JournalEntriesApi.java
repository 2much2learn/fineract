...
public interface JournalEntriesApi {
  ...
  Call<PostJournalEntriesResponse> createGLJournalEntry(
                    @retrofit2.http.Body JournalEntryCommand body    ,     @retrofit2.http.Query("command") String command                
  );
  ...
  Call<PostJournalEntriesTransactionIdResponse> createReversalJournalEntry(
            @retrofit2.http.Path("transactionId") String transactionId            ,                 @retrofit2.http.Body PostJournalEntriesTransactionIdRequest body    ,     @retrofit2.http.Query("command") String command                
  );
